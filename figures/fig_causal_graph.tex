...
\caption{Causal threat graph of exploit propagation paths (P1--P5) to target assets (G1--G4). Red nodes indicate adversary footholds, blue nodes show internal execution components, and purple nodes denote target assets. Green dashed contours mark interdiction barriers that sever the kill chain.}
