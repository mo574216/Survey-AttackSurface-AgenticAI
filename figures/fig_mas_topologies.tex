...
\caption{Multi-Agent System (MAS) coordination topologies and vulnerability propagation dynamics across three canonical architectures: (a) Hierarchical Orchestrator, (b) Decentralized Swarm Mesh, and (c) Shared Blackboard. Rounded background cards delineate topological trust boundaries; red dashed circles with asterisks (*) mark compromised/adversarial agents; solid arrows indicate legitimate task dispatches and state updates; dashed and dotted red vectors trace exploit mechanics (Upward Prompt Injection, self-replicating prompt worms, and asynchronous state poisoning). Hierarchical systems concentrate catastrophic risk at the central orchestrator, peer meshes foster exponential prompt-worm propagation ($dI/dt$), and shared blackboards subject all downstream consumers to persistent memory corruption.}
